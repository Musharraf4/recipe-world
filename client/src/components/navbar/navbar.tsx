      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between">
          ...
          <div className="hidden md:flex items-center space-x-3 ">
            <Link
              to="/auth"
              className="py-2 px-2 font-medium text-white bg-[#DAB600] rounded hover:bg-[#e9d700] transition duration-300"
            >
              Login
            </Link>
          </div>
      ...
      <div className="hidden mobile-menu">
        <ul className="">
          <li >
            <a
              href="index.html"
              className="block text-sm px-2 py-4 text-white bg-[#DAB600] font-semibold"
            >
              Home
            </a>
          </li>
